...
export const differentials = [
  {
    ...
    description: "Estratégias avançadas de SEO para aumentar sua visibilidade nos mecanismos de busca e atrair tráfego qualificado.",
  },
  {
  ...
  },
  {
    ...
    description: "Cada projeto é único. Criamos soluções sob medida que se adaptam ao perfil e aos objetivos do seu negócio.",
  },
  {
    icon: <Star className="h-6 w-6" />,
    title: "Foco em ROI e Conversão",
    description: "Todas as nossas ações são voltadas para gerar retorno sobre o investimento e maximizar suas conversões.",
  },
  {
